...
public class SpriteOutline : MonoBehaviour
{
    ...
    public struct Directions
    {
        ...
        public static Directions ON = new Directions(true, true, true, true);
        public static Directions OFF = new Directions(false, false, false, false);
    ...
    [SerializeField]
    public Directions directions = new Directions(true, true, true, true);
